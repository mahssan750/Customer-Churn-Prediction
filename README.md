...
- Python 3.11+
- Your data file: a transaction CSV with columns `CustomerID`, `InvoiceNo`, `InvoiceDate`, `StockCode`, `Quantity`, `Revenue`, `Country`
...
data/
└── raw/
    └── cleaned_online_retail.csv    ← place your CSV here
```
